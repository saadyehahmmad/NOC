...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Create a profile for the user with the correct user_type
        ...
        # If the form is invalid, re-render the registration form with errors
        # This ensures that the user gets feedback on what went wrong
        else:
...
def profile(request):
    if request.method == 'POST':
        ...
        if u_form.is_valid() and p_form.is_valid():
            ...
            profile_instance.user = request.user  # Ensure user is set correctly
